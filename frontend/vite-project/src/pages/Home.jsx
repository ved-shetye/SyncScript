...
function Home() {
  ...
  // Example document templates (replace with your actual documents)
  const documentTemplates = [
    { name: "Blank Document", icon: "+", file: null },
    { name: "Resume Serif", file: "../assets/Resume.docx" },
    { name: "Resume Coral", file: "../assets/Resume2.docx" },
    { name: "Meeting Notes", file: "../assets/Letter.docx" },
  ];
    ...
    <div className="bg-gray-900 min-h-screen text-gray-200 font-sans">
      ...
      <nav className="bg-gray-800 p-4 shadow-lg flex justify-between items-center">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg transition duration-150">
            New +
          </button>
      ...
      <div className="max-w-6xl mx-auto p-8">
        ...
        <div className="bg-gray-800 p-6 rounded-xl shadow-lg mb-8">
          <div className="flex justify-between items-center mb-6">
            ...
            <button className="text-blue-400 hover:text-blue-300 text-sm">View all templates</button>
          </div>
